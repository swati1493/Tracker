...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini">BOD</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Brands Of Desire</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Swati Verma</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="{{ url('/add_resourceavailability') }}">
            <i class=""></i> <span>CAPABILITY MANAGEMENT MASTER</span>
         ...
         <!--  <ul class="treeview-menu">
          ...
          <li class="treeview">
          <a href="#">
            <i class=""></i> <span>CLIENT MASTER</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <!--  <ul class="treeview-menu">
          ...
          <li class="treeview">
          <a href="#">
            <i class=""></i> <span>CASE MASTER</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <!--  <ul class="treeview-menu">
          ...
          <li class="treeview">
          <a href="#">
            <i class=""></i> <span>DELIVERABLE MASTER</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <!--  <ul class="treeview-menu">
          ...
          <li class="treeview">
          <a href="#">
            <i class=""></i> <span>TIME-SHEET</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<div class="container-fluid" >
    <div class="row" style="color: black;font-weight: bold;">
        <div class="col-md-16 col-md-offset-0">
            <div class="panel panel-default pull-top" style="background-color: #D0ECE7  ">
                <div class="panel-heading" style="background-color:#DA2632;"><center style="font-size: 20px;color: #ffffff;">&#128522 CAPABILITY MANAGEMENT MASTER &#128522</center></div>
                   <center>
...
tr:nth-child(even) {
    background-color: #f2f2f2
            ...
            <div class="form-group">
                 ...
                 <div class="form-group">
                <input type="submit" class="btn btn-md btn-success" name="submit" value="Search" style="">
               </div>
            </form><br>
...
@foreach($resource as $rec)
  <tr>
    ...
    <td style="text-align: center;">{{$rec->designation}}</td>
     <td style="text-align: center;">{{$rec->resource_category}}</td>
    ...
    <td style="text-align: center;">{{$rec->domain}}</td>
