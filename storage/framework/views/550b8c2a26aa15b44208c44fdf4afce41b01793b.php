...
<head>
    ...
    <title><?php echo e(config('app.name', 'BOD')); ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" style="background-color: #212121;margin-bottom: 0px;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a ><img style="padding-top: 15px;" width="50%" src="<?php echo e(asset('http://bodservers.com/assets/img/bod-logo-white-2.png')); ?>"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(Auth::guest()): ?>
                           <!--  <li><a href="<?php echo e(url('/login')); ?>" style="color: #ffffff;font-size: 16px;font-weight: bolder;">Login</a></li> -->
