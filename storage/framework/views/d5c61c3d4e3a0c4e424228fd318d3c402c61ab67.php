...
<?php $__currentLoopData = $task; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
    <td><?php echo e($tra->date); ?></td>
     <td><?php echo e($tra->createdby_name); ?></td>
    <td><?php echo e($tra->client_name); ?></td>
    <td><?php echo e($tra->project_name); ?></td>
    <td><?php echo e($tra->deliverable_name); ?></td>
    <td><?php echo e($tra->task); ?></td>
    <td><?php echo e($tra->hours); ?></td>
  </tr>
